...
export const Thread: FC = () => {
  return (
    <ThreadPrimitive.Root className="bg-background box-border h-full flex flex-col">
      {/* Scrollable container for messages */}
      <div className="flex-grow overflow-y-auto pb-4">
        <ThreadPrimitive.Viewport className="flex flex-col items-center scroll-smooth bg-inherit px-4 pt-8">
            <ThreadWelcome />
      ...
      <div className="sticky bottom-0 flex w-full max-w-[var(--thread-max-width)] flex-col items-center justify-end bg-inherit px-4 py-4 pb-4">
